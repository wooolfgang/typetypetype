...
exports.default = function () {
  ...
  return function (hook) {
    ...
    var roles = (0, _lodash4.default)(hook.params.user, options.fieldName);
    ...
    if (options.owner && !authorized) {
      if (hook.id === null) {
        throw new _feathersErrors2.default.BadRequest('Can not verify roles when changing many resources.');
      }
      ...
      return this.get(hook.id, params).then(function (data) {
        if (data.toJSON) {
          data = data.toJSON();
        ...
        if ((0, _lodash2.default)(field)) {
          field = (0, _lodash4.default)(field, options.idField);
        }
